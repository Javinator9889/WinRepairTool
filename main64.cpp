...
int main() {
    ...
    if (!IsCurrentUserLocalAdministrator()){
        ...
        system("cls");
        cout << "+---------------------------+---------------+\n"
                "| Windows Repair Tool (x64) | Version: 0.9  |\n"
                "+---------------------------+---------------+\n"
                "\n"
        ...
        if (IsWindows8OrGreater()) {
            ...
            if (!IsWow64()) {
                LOG_FATAL << "32-bit OS. This version is for 64-bit. Exiting . . .";
                cout << "It seems that your Windows is 32-bit version. This is for 64-bit OS\n"
                        "\n"
                        "Please, go to  > https://github.com/Javinator9889/WinRepairTool#downloads <   and get the 32-bit version\n" << endl;
                system("pause");
                exit(1);
            } else if (bConnect()) {
